...
class ysyx_25030077_IDU extends Module {
  ...
  io.r_valid := MuxCase(false.B, Seq(
    islw -> true.B,
    islh -> true.B,
    islhu -> true.B,
    islbu -> true.B,
