...
module ysyx_25030077_IDU(
  ...
  wire  isaddi = _isaddi_T_2 == 10'h13; // @[ysyx_25030077_IDU.scala 296:64]
  wire  isxori = _isaddi_T_2 == 10'h213; // @[ysyx_25030077_IDU.scala 297:64]
  wire  isori = _isaddi_T_2 == 10'h313; // @[ysyx_25030077_IDU.scala 298:64]
  wire  isandi = _isaddi_T_2 == 10'h393; // @[ysyx_25030077_IDU.scala 299:64]
  wire [15:0] _issrai_T_3 = {io_instruction[31:26],io_instruction[14:12],io_instruction[6:0]}; // @[Cat.scala 31:58]
  wire  issrai = _issrai_T_3 == 16'h4293; // @[ysyx_25030077_IDU.scala 300:87]
  wire  issrli = _issrai_T_3 == 16'h293; // @[ysyx_25030077_IDU.scala 301:87]
  wire  isslli = _issrai_T_3 == 16'h93; // @[ysyx_25030077_IDU.scala 302:87]
  wire  issra = _issrai_T_3 == 16'h42b3; // @[ysyx_25030077_IDU.scala 303:87]
  wire  issrl = _issrai_T_3 == 16'h2b3; // @[ysyx_25030077_IDU.scala 304:87]
  wire  isbeq = _isaddi_T_2 == 10'h63; // @[ysyx_25030077_IDU.scala 305:64]
  wire  isbne = _isaddi_T_2 == 10'he3; // @[ysyx_25030077_IDU.scala 306:64]
  wire [16:0] _isadd_T_3 = {io_instruction[31:25],io_instruction[14:12],io_instruction[6:0]}; // @[Cat.scala 31:58]
  wire  isadd = _isadd_T_3 == 17'h33; // @[ysyx_25030077_IDU.scala 307:87]
  wire  isxor = _isadd_T_3 == 17'h233; // @[ysyx_25030077_IDU.scala 308:87]
  wire  isand = _isadd_T_3 == 17'h3b3; // @[ysyx_25030077_IDU.scala 309:87]
  wire  isor = _isadd_T_3 == 17'h333; // @[ysyx_25030077_IDU.scala 310:87]
  wire  issub = _isadd_T_3 == 17'h8033; // @[ysyx_25030077_IDU.scala 311:87]
  wire  islui = io_instruction[6:0] == 7'h37; // @[ysyx_25030077_IDU.scala 312:36]
  wire  isauipc = io_instruction[6:0] == 7'h17; // @[ysyx_25030077_IDU.scala 313:38]
  wire  isjal = io_instruction[6:0] == 7'h6f; // @[ysyx_25030077_IDU.scala 314:36]
  wire  isjalr = _isaddi_T_2 == 10'h67; // @[ysyx_25030077_IDU.scala 315:65]
  wire  issw = _isaddi_T_2 == 10'h123; // @[ysyx_25030077_IDU.scala 316:63]
  wire  isbge = _isaddi_T_2 == 10'h2e3; // @[ysyx_25030077_IDU.scala 317:63]
  wire  isblt = _isaddi_T_2 == 10'h263; // @[ysyx_25030077_IDU.scala 318:63]
  wire  isbltu = _isaddi_T_2 == 10'h363; // @[ysyx_25030077_IDU.scala 319:63]
  wire  isbgeu = _isaddi_T_2 == 10'h3e3; // @[ysyx_25030077_IDU.scala 320:63]
  wire  issb = _isaddi_T_2 == 10'h23; // @[ysyx_25030077_IDU.scala 321:63]
  wire  issh = _isaddi_T_2 == 10'ha3; // @[ysyx_25030077_IDU.scala 322:63]
  wire  islbu = _isaddi_T_2 == 10'h203; // @[ysyx_25030077_IDU.scala 323:63]
  wire  islb = _isaddi_T_2 == 10'h3; // @[ysyx_25030077_IDU.scala 324:63]
  wire  islw = _isaddi_T_2 == 10'h103; // @[ysyx_25030077_IDU.scala 325:63]
  wire  islh = _isaddi_T_2 == 10'h83; // @[ysyx_25030077_IDU.scala 326:63]
  wire  islhu = _isaddi_T_2 == 10'h283; // @[ysyx_25030077_IDU.scala 327:63]
  wire  issll = _isadd_T_3 == 17'hb3; // @[ysyx_25030077_IDU.scala 328:86]
  wire  isslt = _isadd_T_3 == 17'h133; // @[ysyx_25030077_IDU.scala 329:88]
  wire  issltu = _isadd_T_3 == 17'h1b3; // @[ysyx_25030077_IDU.scala 330:88]
  wire  issltiu = _isaddi_T_2 == 10'h193; // @[ysyx_25030077_IDU.scala 331:65]
  wire  isslti = _isaddi_T_2 == 10'h113; // @[ysyx_25030077_IDU.scala 332:65]
  wire  iscsrrw = _isaddi_T_2 == 10'hf3; // @[ysyx_25030077_IDU.scala 333:67]
  wire  iscsrrs = _isaddi_T_2 == 10'h173; // @[ysyx_25030077_IDU.scala 334:67]
  wire  isebreak = io_instruction == 32'h100073; // @[ysyx_25030077_IDU.scala 335:34]
  wire  isecall = io_instruction == 32'h73; // @[ysyx_25030077_IDU.scala 336:34]
  wire  isfencei = io_instruction == 32'h100f; // @[ysyx_25030077_IDU.scala 337:34]
  wire  ismret = io_instruction == 32'h30200073; // @[ysyx_25030077_IDU.scala 338:34]
  wire [2:0] _io_imm_type_T = isfencei ? 3'h3 : 3'h0; // @[Mux.scala 101:16]
  wire [2:0] _io_imm_type_T_1 = islb ? 3'h1 : _io_imm_type_T; // @[Mux.scala 101:16]
  wire [2:0] _io_imm_type_T_2 = islbu ? 3'h1 : _io_imm_type_T_1; // @[Mux.scala 101:16]
  wire [2:0] _io_imm_type_T_3 = islhu ? 3'h1 : _io_imm_type_T_2; // @[Mux.scala 101:16]
  wire [2:0] _io_imm_type_T_4 = islh ? 3'h1 : _io_imm_type_T_3; // @[Mux.scala 101:16]
  wire [2:0] _io_imm_type_T_5 = islw ? 3'h1 : _io_imm_type_T_4; // @[Mux.scala 101:16]
  wire [2:0] _io_imm_type_T_6 = issh ? 3'h4 : _io_imm_type_T_5; // @[Mux.scala 101:16]
  wire [2:0] _io_imm_type_T_7 = issb ? 3'h4 : _io_imm_type_T_6; // @[Mux.scala 101:16]
  wire [2:0] _io_imm_type_T_8 = issw ? 3'h4 : _io_imm_type_T_7; // @[Mux.scala 101:16]
  wire [2:0] _io_imm_type_T_9 = isjalr ? 3'h3 : _io_imm_type_T_8; // @[Mux.scala 101:16]
  wire [2:0] _io_imm_type_T_10 = isjal ? 3'h3 : _io_imm_type_T_9; // @[Mux.scala 101:16]
  wire [2:0] _io_imm_type_T_11 = isauipc ? 3'h2 : _io_imm_type_T_10; // @[Mux.scala 101:16]
  wire [2:0] _io_imm_type_T_12 = islui ? 3'h2 : _io_imm_type_T_11; // @[Mux.scala 101:16]
  wire [2:0] _io_imm_type_T_13 = isslti ? 3'h1 : _io_imm_type_T_12; // @[Mux.scala 101:16]
  wire [2:0] _io_imm_type_T_14 = issltiu ? 3'h1 : _io_imm_type_T_13; // @[Mux.scala 101:16]
  wire [2:0] _io_imm_type_T_15 = isslli ? 3'h5 : _io_imm_type_T_14; // @[Mux.scala 101:16]
  wire [2:0] _io_imm_type_T_16 = issrli ? 3'h5 : _io_imm_type_T_15; // @[Mux.scala 101:16]
  wire [2:0] _io_imm_type_T_17 = issrai ? 3'h5 : _io_imm_type_T_16; // @[Mux.scala 101:16]
  wire [2:0] _io_imm_type_T_18 = iscsrrs ? 3'h6 : _io_imm_type_T_17; // @[Mux.scala 101:16]
  wire [2:0] _io_imm_type_T_19 = iscsrrw ? 3'h6 : _io_imm_type_T_18; // @[Mux.scala 101:16]
  wire [2:0] _io_imm_type_T_20 = isandi ? 3'h1 : _io_imm_type_T_19; // @[Mux.scala 101:16]
  wire [2:0] _io_imm_type_T_21 = isori ? 3'h1 : _io_imm_type_T_20; // @[Mux.scala 101:16]
  wire [2:0] _io_imm_type_T_22 = isxori ? 3'h1 : _io_imm_type_T_21; // @[Mux.scala 101:16]
  ...
  wire [4:0] _io_rd_T = isfencei ? 5'h13 : 5'h0; // @[Mux.scala 101:16]
  wire [4:0] _io_rd_T_1 = isslt ? addi_Rd : _io_rd_T; // @[Mux.scala 101:16]
  wire [4:0] _io_rd_T_2 = issltu ? addi_Rd : _io_rd_T_1; // @[Mux.scala 101:16]
  wire [4:0] _io_rd_T_3 = issub ? addi_Rd : _io_rd_T_2; // @[Mux.scala 101:16]
  wire [4:0] _io_rd_T_4 = isor ? addi_Rd : _io_rd_T_3; // @[Mux.scala 101:16]
  wire [4:0] _io_rd_T_5 = isxor ? addi_Rd : _io_rd_T_4; // @[Mux.scala 101:16]
  wire [4:0] _io_rd_T_6 = issrl ? addi_Rd : _io_rd_T_5; // @[Mux.scala 101:16]
  wire [4:0] _io_rd_T_7 = issra ? addi_Rd : _io_rd_T_6; // @[Mux.scala 101:16]
  wire [4:0] _io_rd_T_8 = issll ? addi_Rd : _io_rd_T_7; // @[Mux.scala 101:16]
  wire [4:0] _io_rd_T_9 = isand ? addi_Rd : _io_rd_T_8; // @[Mux.scala 101:16]
  wire [4:0] _io_rd_T_10 = isadd ? addi_Rd : _io_rd_T_9; // @[Mux.scala 101:16]
  wire [4:0] _io_rd_T_11 = islb ? addi_Rd : _io_rd_T_10; // @[Mux.scala 101:16]
  wire [4:0] _io_rd_T_12 = islbu ? addi_Rd : _io_rd_T_11; // @[Mux.scala 101:16]
  wire [4:0] _io_rd_T_13 = islhu ? addi_Rd : _io_rd_T_12; // @[Mux.scala 101:16]
  wire [4:0] _io_rd_T_14 = islh ? addi_Rd : _io_rd_T_13; // @[Mux.scala 101:16]
  wire [4:0] _io_rd_T_15 = islw ? addi_Rd : _io_rd_T_14; // @[Mux.scala 101:16]
  wire [4:0] _io_rd_T_16 = isjalr ? addi_Rd : _io_rd_T_15; // @[Mux.scala 101:16]
  wire [4:0] _io_rd_T_17 = isjal ? addi_Rd : _io_rd_T_16; // @[Mux.scala 101:16]
  wire [4:0] _io_rd_T_18 = isauipc ? addi_Rd : _io_rd_T_17; // @[Mux.scala 101:16]
  wire [4:0] _io_rd_T_19 = islui ? addi_Rd : _io_rd_T_18; // @[Mux.scala 101:16]
  wire [4:0] _io_rd_T_20 = isslti ? addi_Rd : _io_rd_T_19; // @[Mux.scala 101:16]
  wire [4:0] _io_rd_T_21 = issltiu ? addi_Rd : _io_rd_T_20; // @[Mux.scala 101:16]
  wire [4:0] _io_rd_T_22 = isslli ? addi_Rd : _io_rd_T_21; // @[Mux.scala 101:16]
  wire [4:0] _io_rd_T_23 = issrli ? addi_Rd : _io_rd_T_22; // @[Mux.scala 101:16]
  wire [4:0] _io_rd_T_24 = issrai ? addi_Rd : _io_rd_T_23; // @[Mux.scala 101:16]
  wire [4:0] _io_rd_T_25 = iscsrrs ? addi_Rd : _io_rd_T_24; // @[Mux.scala 101:16]
  wire [4:0] _io_rd_T_26 = iscsrrw ? addi_Rd : _io_rd_T_25; // @[Mux.scala 101:16]
  wire [4:0] _io_rd_T_27 = isandi ? addi_Rd : _io_rd_T_26; // @[Mux.scala 101:16]
  wire [4:0] _io_rd_T_28 = isori ? addi_Rd : _io_rd_T_27; // @[Mux.scala 101:16]
  wire [4:0] _io_rd_T_29 = isxori ? addi_Rd : _io_rd_T_28; // @[Mux.scala 101:16]
  wire [4:0] _io_ALU_ctrl_T_1 = issltu ? 5'h2 : 5'h0; // @[Mux.scala 101:16]
  wire [4:0] _io_ALU_ctrl_T_2 = isslt ? 5'ha : _io_ALU_ctrl_T_1; // @[Mux.scala 101:16]
  wire [4:0] _io_ALU_ctrl_T_3 = isbne ? 5'h0 : _io_ALU_ctrl_T_2; // @[Mux.scala 101:16]
  wire [4:0] _io_ALU_ctrl_T_4 = isbgeu ? 5'h0 : _io_ALU_ctrl_T_3; // @[Mux.scala 101:16]
  wire [4:0] _io_ALU_ctrl_T_5 = isbltu ? 5'h0 : _io_ALU_ctrl_T_4; // @[Mux.scala 101:16]
  wire [4:0] _io_ALU_ctrl_T_6 = isblt ? 5'h0 : _io_ALU_ctrl_T_5; // @[Mux.scala 101:16]
  wire [4:0] _io_ALU_ctrl_T_7 = isbge ? 5'h0 : _io_ALU_ctrl_T_6; // @[Mux.scala 101:16]
  wire [4:0] _io_ALU_ctrl_T_8 = isbeq ? 5'h0 : _io_ALU_ctrl_T_7; // @[Mux.scala 101:16]
  wire [4:0] _io_ALU_ctrl_T_9 = issub ? 5'h1 : _io_ALU_ctrl_T_8; // @[Mux.scala 101:16]
  wire [4:0] _io_ALU_ctrl_T_10 = isor ? 5'h3 : _io_ALU_ctrl_T_9; // @[Mux.scala 101:16]
  wire [4:0] _io_ALU_ctrl_T_11 = isxor ? 5'h4 : _io_ALU_ctrl_T_10; // @[Mux.scala 101:16]
  wire [4:0] _io_ALU_ctrl_T_12 = issrl ? 5'h9 : _io_ALU_ctrl_T_11; // @[Mux.scala 101:16]
  wire [4:0] _io_ALU_ctrl_T_13 = issra ? 5'h5 : _io_ALU_ctrl_T_12; // @[Mux.scala 101:16]
  wire [4:0] _io_ALU_ctrl_T_14 = issll ? 5'h8 : _io_ALU_ctrl_T_13; // @[Mux.scala 101:16]
  wire [4:0] _io_ALU_ctrl_T_15 = isand ? 5'h6 : _io_ALU_ctrl_T_14; // @[Mux.scala 101:16]
  wire [4:0] _io_ALU_ctrl_T_16 = isadd ? 5'h0 : _io_ALU_ctrl_T_15; // @[Mux.scala 101:16]
  wire [4:0] _io_ALU_ctrl_T_17 = islb ? 5'h0 : _io_ALU_ctrl_T_16; // @[Mux.scala 101:16]
  wire [4:0] _io_ALU_ctrl_T_18 = islbu ? 5'h0 : _io_ALU_ctrl_T_17; // @[Mux.scala 101:16]
  wire [4:0] _io_ALU_ctrl_T_19 = islhu ? 5'h0 : _io_ALU_ctrl_T_18; // @[Mux.scala 101:16]
  wire [4:0] _io_ALU_ctrl_T_20 = islh ? 5'h0 : _io_ALU_ctrl_T_19; // @[Mux.scala 101:16]
  wire [4:0] _io_ALU_ctrl_T_21 = islw ? 5'h0 : _io_ALU_ctrl_T_20; // @[Mux.scala 101:16]
  wire [4:0] _io_ALU_ctrl_T_22 = issh ? 5'h0 : _io_ALU_ctrl_T_21; // @[Mux.scala 101:16]
  wire [4:0] _io_ALU_ctrl_T_23 = issb ? 5'h0 : _io_ALU_ctrl_T_22; // @[Mux.scala 101:16]
  wire [4:0] _io_ALU_ctrl_T_24 = issw ? 5'h0 : _io_ALU_ctrl_T_23; // @[Mux.scala 101:16]
  wire [4:0] _io_ALU_ctrl_T_25 = isjalr ? 5'h0 : _io_ALU_ctrl_T_24; // @[Mux.scala 101:16]
  wire [4:0] _io_ALU_ctrl_T_26 = isjal ? 5'h0 : _io_ALU_ctrl_T_25; // @[Mux.scala 101:16]
  wire [4:0] _io_ALU_ctrl_T_27 = isauipc ? 5'h0 : _io_ALU_ctrl_T_26; // @[Mux.scala 101:16]
  wire [4:0] _io_ALU_ctrl_T_28 = islui ? 5'h0 : _io_ALU_ctrl_T_27; // @[Mux.scala 101:16]
  wire [4:0] _io_ALU_ctrl_T_29 = isslti ? 5'ha : _io_ALU_ctrl_T_28; // @[Mux.scala 101:16]
  wire [4:0] _io_ALU_ctrl_T_30 = issltiu ? 5'h2 : _io_ALU_ctrl_T_29; // @[Mux.scala 101:16]
  wire [4:0] _io_ALU_ctrl_T_31 = isslli ? 5'h8 : _io_ALU_ctrl_T_30; // @[Mux.scala 101:16]
  wire [4:0] _io_ALU_ctrl_T_32 = issrli ? 5'h9 : _io_ALU_ctrl_T_31; // @[Mux.scala 101:16]
  wire [4:0] _io_ALU_ctrl_T_33 = issrai ? 5'h5 : _io_ALU_ctrl_T_32; // @[Mux.scala 101:16]
  wire [4:0] _io_ALU_ctrl_T_34 = iscsrrs ? 5'hc : _io_ALU_ctrl_T_33; // @[Mux.scala 101:16]
  wire [4:0] _io_ALU_ctrl_T_35 = iscsrrw ? 5'hb : _io_ALU_ctrl_T_34; // @[Mux.scala 101:16]
  wire [4:0] _io_ALU_ctrl_T_36 = isandi ? 5'h6 : _io_ALU_ctrl_T_35; // @[Mux.scala 101:16]
  wire [4:0] _io_ALU_ctrl_T_37 = isori ? 5'h3 : _io_ALU_ctrl_T_36; // @[Mux.scala 101:16]
  wire [4:0] _io_ALU_ctrl_T_38 = isxori ? 5'h4 : _io_ALU_ctrl_T_37; // @[Mux.scala 101:16]
  wire [4:0] _io_ALU_ctrl_T_39 = isaddi ? 5'h0 : _io_ALU_ctrl_T_38; // @[Mux.scala 101:16]
  wire [2:0] _io_data_control_T = isfencei ? 3'h1 : 3'h0; // @[Mux.scala 101:16]
  wire [2:0] _io_data_control_T_1 = issltu ? 3'h3 : _io_data_control_T; // @[Mux.scala 101:16]
  wire [2:0] _io_data_control_T_2 = isslt ? 3'h3 : _io_data_control_T_1; // @[Mux.scala 101:16]
  wire [2:0] _io_data_control_T_3 = isbne ? 3'h0 : _io_data_control_T_2; // @[Mux.scala 101:16]
  wire [2:0] _io_data_control_T_4 = isbgeu ? 3'h0 : _io_data_control_T_3; // @[Mux.scala 101:16]
  wire [2:0] _io_data_control_T_5 = isbltu ? 3'h0 : _io_data_control_T_4; // @[Mux.scala 101:16]
  wire [2:0] _io_data_control_T_6 = isblt ? 3'h0 : _io_data_control_T_5; // @[Mux.scala 101:16]
  wire [2:0] _io_data_control_T_7 = isbge ? 3'h0 : _io_data_control_T_6; // @[Mux.scala 101:16]
  wire [2:0] _io_data_control_T_8 = isbeq ? 3'h0 : _io_data_control_T_7; // @[Mux.scala 101:16]
  wire [2:0] _io_data_control_T_9 = issub ? 3'h3 : _io_data_control_T_8; // @[Mux.scala 101:16]
  wire [2:0] _io_data_control_T_10 = isor ? 3'h3 : _io_data_control_T_9; // @[Mux.scala 101:16]
  wire [2:0] _io_data_control_T_11 = isxor ? 3'h3 : _io_data_control_T_10; // @[Mux.scala 101:16]
  wire [2:0] _io_data_control_T_12 = issrl ? 3'h3 : _io_data_control_T_11; // @[Mux.scala 101:16]
  wire [2:0] _io_data_control_T_13 = issra ? 3'h3 : _io_data_control_T_12; // @[Mux.scala 101:16]
  wire [2:0] _io_data_control_T_14 = issll ? 3'h3 : _io_data_control_T_13; // @[Mux.scala 101:16]
  wire [2:0] _io_data_control_T_15 = isand ? 3'h3 : _io_data_control_T_14; // @[Mux.scala 101:16]
  wire [2:0] _io_data_control_T_16 = isadd ? 3'h3 : _io_data_control_T_15; // @[Mux.scala 101:16]
  wire [2:0] _io_data_control_T_17 = islb ? 3'h2 : _io_data_control_T_16; // @[Mux.scala 101:16]
  wire [2:0] _io_data_control_T_18 = islbu ? 3'h2 : _io_data_control_T_17; // @[Mux.scala 101:16]
  wire [2:0] _io_data_control_T_19 = islhu ? 3'h2 : _io_data_control_T_18; // @[Mux.scala 101:16]
  wire [2:0] _io_data_control_T_20 = islh ? 3'h2 : _io_data_control_T_19; // @[Mux.scala 101:16]
  wire [2:0] _io_data_control_T_21 = islw ? 3'h2 : _io_data_control_T_20; // @[Mux.scala 101:16]
  wire [2:0] _io_data_control_T_22 = issh ? 3'h0 : _io_data_control_T_21; // @[Mux.scala 101:16]
  wire [2:0] _io_data_control_T_23 = issb ? 3'h0 : _io_data_control_T_22; // @[Mux.scala 101:16]
  wire [2:0] _io_data_control_T_24 = issw ? 3'h0 : _io_data_control_T_23; // @[Mux.scala 101:16]
  wire [2:0] _io_data_control_T_25 = isjalr ? 3'h1 : _io_data_control_T_24; // @[Mux.scala 101:16]
  wire [2:0] _io_data_control_T_26 = isjal ? 3'h1 : _io_data_control_T_25; // @[Mux.scala 101:16]
  wire [3:0] _io_pc_next_type_T = isfencei ? 4'hd : 4'h3; // @[Mux.scala 101:16]
  wire [3:0] _io_pc_next_type_T_1 = isslti ? 4'h0 : _io_pc_next_type_T; // @[Mux.scala 101:16]
  wire [3:0] _io_pc_next_type_T_2 = issltiu ? 4'h0 : _io_pc_next_type_T_1; // @[Mux.scala 101:16]
  wire [3:0] _io_pc_next_type_T_3 = isslt ? 4'h0 : _io_pc_next_type_T_2; // @[Mux.scala 101:16]
  wire [3:0] _io_pc_next_type_T_4 = issltu ? 4'h0 : _io_pc_next_type_T_3; // @[Mux.scala 101:16]
  wire [3:0] _io_pc_next_type_T_5 = isbne ? 4'h5 : _io_pc_next_type_T_4; // @[Mux.scala 101:16]
  wire [3:0] _io_pc_next_type_T_6 = isbgeu ? 4'h8 : _io_pc_next_type_T_5; // @[Mux.scala 101:16]
  wire [3:0] _io_pc_next_type_T_7 = isbltu ? 4'ha : _io_pc_next_type_T_6; // @[Mux.scala 101:16]
  wire [3:0] _io_pc_next_type_T_8 = isblt ? 4'h9 : _io_pc_next_type_T_7; // @[Mux.scala 101:16]
  wire [3:0] _io_pc_next_type_T_9 = isbge ? 4'h7 : _io_pc_next_type_T_8; // @[Mux.scala 101:16]
  wire [3:0] _io_pc_next_type_T_10 = isbeq ? 4'h6 : _io_pc_next_type_T_9; // @[Mux.scala 101:16]
  wire [3:0] _io_pc_next_type_T_11 = issub ? 4'h0 : _io_pc_next_type_T_10; // @[Mux.scala 101:16]
  wire [3:0] _io_pc_next_type_T_12 = isor ? 4'h0 : _io_pc_next_type_T_11; // @[Mux.scala 101:16]
  wire [3:0] _io_pc_next_type_T_13 = isxor ? 4'h0 : _io_pc_next_type_T_12; // @[Mux.scala 101:16]
  wire [3:0] _io_pc_next_type_T_14 = issrl ? 4'h0 : _io_pc_next_type_T_13; // @[Mux.scala 101:16]
  wire [3:0] _io_pc_next_type_T_15 = issra ? 4'h0 : _io_pc_next_type_T_14; // @[Mux.scala 101:16]
  wire [3:0] _io_pc_next_type_T_16 = issll ? 4'h0 : _io_pc_next_type_T_15; // @[Mux.scala 101:16]
  wire [3:0] _io_pc_next_type_T_17 = isand ? 4'h0 : _io_pc_next_type_T_16; // @[Mux.scala 101:16]
  wire [3:0] _io_pc_next_type_T_18 = isadd ? 4'h0 : _io_pc_next_type_T_17; // @[Mux.scala 101:16]
  wire [3:0] _io_pc_next_type_T_19 = islb ? 4'h0 : _io_pc_next_type_T_18; // @[Mux.scala 101:16]
  wire [3:0] _io_pc_next_type_T_20 = islbu ? 4'h0 : _io_pc_next_type_T_19; // @[Mux.scala 101:16]
  wire [3:0] _io_pc_next_type_T_21 = islhu ? 4'h0 : _io_pc_next_type_T_20; // @[Mux.scala 101:16]
  wire [3:0] _io_pc_next_type_T_22 = islh ? 4'h0 : _io_pc_next_type_T_21; // @[Mux.scala 101:16]
  wire [3:0] _io_pc_next_type_T_23 = islw ? 4'h0 : _io_pc_next_type_T_22; // @[Mux.scala 101:16]
  wire [3:0] _io_pc_next_type_T_24 = ismret ? 4'hc : _io_pc_next_type_T_23; // @[Mux.scala 101:16]
  wire [3:0] _io_pc_next_type_T_25 = isecall ? 4'hb : _io_pc_next_type_T_24; // @[Mux.scala 101:16]
  wire [3:0] _io_pc_next_type_T_26 = isebreak ? 4'h4 : _io_pc_next_type_T_25; // @[Mux.scala 101:16]
  wire [3:0] _io_pc_next_type_T_27 = issh ? 4'h0 : _io_pc_next_type_T_26; // @[Mux.scala 101:16]
  wire [3:0] _io_pc_next_type_T_28 = issb ? 4'h0 : _io_pc_next_type_T_27; // @[Mux.scala 101:16]
  wire [3:0] _io_pc_next_type_T_29 = issw ? 4'h0 : _io_pc_next_type_T_28; // @[Mux.scala 101:16]
  wire [3:0] _io_pc_next_type_T_30 = isslli ? 4'h0 : _io_pc_next_type_T_29; // @[Mux.scala 101:16]
  wire [3:0] _io_pc_next_type_T_31 = issrli ? 4'h0 : _io_pc_next_type_T_30; // @[Mux.scala 101:16]
  wire [3:0] _io_pc_next_type_T_32 = issrai ? 4'h0 : _io_pc_next_type_T_31; // @[Mux.scala 101:16]
  wire [3:0] _io_pc_next_type_T_33 = iscsrrs ? 4'h0 : _io_pc_next_type_T_32; // @[Mux.scala 101:16]
  wire [3:0] _io_pc_next_type_T_34 = iscsrrw ? 4'h0 : _io_pc_next_type_T_33; // @[Mux.scala 101:16]
  wire [3:0] _io_pc_next_type_T_35 = isandi ? 4'h0 : _io_pc_next_type_T_34; // @[Mux.scala 101:16]
  wire [3:0] _io_pc_next_type_T_36 = isori ? 4'h0 : _io_pc_next_type_T_35; // @[Mux.scala 101:16]
  wire [3:0] _io_pc_next_type_T_37 = isxori ? 4'h0 : _io_pc_next_type_T_36; // @[Mux.scala 101:16]
  wire [3:0] _io_pc_next_type_T_38 = isaddi ? 4'h0 : _io_pc_next_type_T_37; // @[Mux.scala 101:16]
  wire [3:0] _io_pc_next_type_T_39 = islui ? 4'h0 : _io_pc_next_type_T_38; // @[Mux.scala 101:16]
  wire [3:0] _io_pc_next_type_T_40 = isauipc ? 4'h0 : _io_pc_next_type_T_39; // @[Mux.scala 101:16]
  wire [3:0] _io_pc_next_type_T_41 = isjalr ? 4'h2 : _io_pc_next_type_T_40; // @[Mux.scala 101:16]
  ...
  assign io_imm_type = isaddi ? 3'h1 : _io_imm_type_T_22; // @[Mux.scala 101:16]
  assign io_rs1 = isaddi ? addi_Rs1 : _io_rs1_T_34; // @[Mux.scala 101:16]
  assign io_rs2 = issw ? sltu_Rs2 : _io_rs2_T_17; // @[Mux.scala 101:16]
  assign io_rd = isaddi ? addi_Rd : _io_rd_T_29; // @[Mux.scala 101:16]
  assign io_data_control = isauipc ? 3'h1 : _io_data_control_T_26; // @[Mux.scala 101:16]
  assign io_ALU_ctrl = _io_ALU_ctrl_T_39[3:0]; // @[ysyx_25030077_IDU.scala 463:15]
  assign io_pc_next_type = isjal ? 4'h1 : _io_pc_next_type_T_41; // @[Mux.scala 101:16]
...
`ifdef RANDOMIZE_REG_INIT
  ...
  reg [31:0] _RAND_33;
`endif // RANDOMIZE_REG_INIT
  reg [31:0] regs_0; // @[ysyx_25030077_gpr.scala 20:21]
  reg [31:0] regs_1; // @[ysyx_25030077_gpr.scala 20:21]
  reg [31:0] regs_2; // @[ysyx_25030077_gpr.scala 20:21]
  reg [31:0] regs_3; // @[ysyx_25030077_gpr.scala 20:21]
  reg [31:0] regs_4; // @[ysyx_25030077_gpr.scala 20:21]
  reg [31:0] regs_5; // @[ysyx_25030077_gpr.scala 20:21]
  reg [31:0] regs_6; // @[ysyx_25030077_gpr.scala 20:21]
  reg [31:0] regs_7; // @[ysyx_25030077_gpr.scala 20:21]
  reg [31:0] regs_8; // @[ysyx_25030077_gpr.scala 20:21]
  reg [31:0] regs_9; // @[ysyx_25030077_gpr.scala 20:21]
  reg [31:0] regs_10; // @[ysyx_25030077_gpr.scala 20:21]
  reg [31:0] regs_11; // @[ysyx_25030077_gpr.scala 20:21]
  reg [31:0] regs_12; // @[ysyx_25030077_gpr.scala 20:21]
  reg [31:0] regs_13; // @[ysyx_25030077_gpr.scala 20:21]
  reg [31:0] regs_14; // @[ysyx_25030077_gpr.scala 20:21]
  reg [31:0] regs_15; // @[ysyx_25030077_gpr.scala 20:21]
  reg [31:0] regs_16; // @[ysyx_25030077_gpr.scala 20:21]
  reg [31:0] regs_17; // @[ysyx_25030077_gpr.scala 20:21]
  reg [31:0] regs_18; // @[ysyx_25030077_gpr.scala 20:21]
  reg [31:0] regs_19; // @[ysyx_25030077_gpr.scala 20:21]
  reg [31:0] regs_20; // @[ysyx_25030077_gpr.scala 20:21]
  reg [31:0] regs_21; // @[ysyx_25030077_gpr.scala 20:21]
  reg [31:0] regs_22; // @[ysyx_25030077_gpr.scala 20:21]
  reg [31:0] regs_23; // @[ysyx_25030077_gpr.scala 20:21]
  reg [31:0] regs_24; // @[ysyx_25030077_gpr.scala 20:21]
  reg [31:0] regs_25; // @[ysyx_25030077_gpr.scala 20:21]
  reg [31:0] regs_26; // @[ysyx_25030077_gpr.scala 20:21]
  reg [31:0] regs_27; // @[ysyx_25030077_gpr.scala 20:21]
  reg [31:0] regs_28; // @[ysyx_25030077_gpr.scala 20:21]
  reg [31:0] regs_29; // @[ysyx_25030077_gpr.scala 20:21]
  reg [31:0] regs_30; // @[ysyx_25030077_gpr.scala 20:21]
  reg [31:0] regs_31; // @[ysyx_25030077_gpr.scala 20:21]
  reg  validReg; // @[ysyx_25030077_gpr.scala 21:25]
  reg [31:0] pc_next_reg; // @[ysyx_25030077_gpr.scala 23:28]
  wire  _validReg_T_1 = io_ifu_Req_ready ? 1'h0 : validReg; // @[ysyx_25030077_gpr.scala 27:20]
  wire [31:0] _GEN_1 = 5'h1 == io_raddr_rs1 ? regs_1 : regs_0; // @[ysyx_25030077_gpr.scala 30:{16,16}]
  wire [31:0] _GEN_2 = 5'h2 == io_raddr_rs1 ? regs_2 : _GEN_1; // @[ysyx_25030077_gpr.scala 30:{16,16}]
  wire [31:0] _GEN_3 = 5'h3 == io_raddr_rs1 ? regs_3 : _GEN_2; // @[ysyx_25030077_gpr.scala 30:{16,16}]
  wire [31:0] _GEN_4 = 5'h4 == io_raddr_rs1 ? regs_4 : _GEN_3; // @[ysyx_25030077_gpr.scala 30:{16,16}]
  wire [31:0] _GEN_5 = 5'h5 == io_raddr_rs1 ? regs_5 : _GEN_4; // @[ysyx_25030077_gpr.scala 30:{16,16}]
  wire [31:0] _GEN_6 = 5'h6 == io_raddr_rs1 ? regs_6 : _GEN_5; // @[ysyx_25030077_gpr.scala 30:{16,16}]
  wire [31:0] _GEN_7 = 5'h7 == io_raddr_rs1 ? regs_7 : _GEN_6; // @[ysyx_25030077_gpr.scala 30:{16,16}]
  wire [31:0] _GEN_8 = 5'h8 == io_raddr_rs1 ? regs_8 : _GEN_7; // @[ysyx_25030077_gpr.scala 30:{16,16}]
  wire [31:0] _GEN_9 = 5'h9 == io_raddr_rs1 ? regs_9 : _GEN_8; // @[ysyx_25030077_gpr.scala 30:{16,16}]
  wire [31:0] _GEN_10 = 5'ha == io_raddr_rs1 ? regs_10 : _GEN_9; // @[ysyx_25030077_gpr.scala 30:{16,16}]
  wire [31:0] _GEN_11 = 5'hb == io_raddr_rs1 ? regs_11 : _GEN_10; // @[ysyx_25030077_gpr.scala 30:{16,16}]
  wire [31:0] _GEN_12 = 5'hc == io_raddr_rs1 ? regs_12 : _GEN_11; // @[ysyx_25030077_gpr.scala 30:{16,16}]
  wire [31:0] _GEN_13 = 5'hd == io_raddr_rs1 ? regs_13 : _GEN_12; // @[ysyx_25030077_gpr.scala 30:{16,16}]
  wire [31:0] _GEN_14 = 5'he == io_raddr_rs1 ? regs_14 : _GEN_13; // @[ysyx_25030077_gpr.scala 30:{16,16}]
  wire [31:0] _GEN_15 = 5'hf == io_raddr_rs1 ? regs_15 : _GEN_14; // @[ysyx_25030077_gpr.scala 30:{16,16}]
  wire [31:0] _GEN_16 = 5'h10 == io_raddr_rs1 ? regs_16 : _GEN_15; // @[ysyx_25030077_gpr.scala 30:{16,16}]
  wire [31:0] _GEN_17 = 5'h11 == io_raddr_rs1 ? regs_17 : _GEN_16; // @[ysyx_25030077_gpr.scala 30:{16,16}]
  wire [31:0] _GEN_18 = 5'h12 == io_raddr_rs1 ? regs_18 : _GEN_17; // @[ysyx_25030077_gpr.scala 30:{16,16}]
  wire [31:0] _GEN_19 = 5'h13 == io_raddr_rs1 ? regs_19 : _GEN_18; // @[ysyx_25030077_gpr.scala 30:{16,16}]
  wire [31:0] _GEN_20 = 5'h14 == io_raddr_rs1 ? regs_20 : _GEN_19; // @[ysyx_25030077_gpr.scala 30:{16,16}]
  wire [31:0] _GEN_21 = 5'h15 == io_raddr_rs1 ? regs_21 : _GEN_20; // @[ysyx_25030077_gpr.scala 30:{16,16}]
  wire [31:0] _GEN_22 = 5'h16 == io_raddr_rs1 ? regs_22 : _GEN_21; // @[ysyx_25030077_gpr.scala 30:{16,16}]
  wire [31:0] _GEN_23 = 5'h17 == io_raddr_rs1 ? regs_23 : _GEN_22; // @[ysyx_25030077_gpr.scala 30:{16,16}]
  wire [31:0] _GEN_24 = 5'h18 == io_raddr_rs1 ? regs_24 : _GEN_23; // @[ysyx_25030077_gpr.scala 30:{16,16}]
  wire [31:0] _GEN_25 = 5'h19 == io_raddr_rs1 ? regs_25 : _GEN_24; // @[ysyx_25030077_gpr.scala 30:{16,16}]
  wire [31:0] _GEN_26 = 5'h1a == io_raddr_rs1 ? regs_26 : _GEN_25; // @[ysyx_25030077_gpr.scala 30:{16,16}]
  wire [31:0] _GEN_27 = 5'h1b == io_raddr_rs1 ? regs_27 : _GEN_26; // @[ysyx_25030077_gpr.scala 30:{16,16}]
  wire [31:0] _GEN_28 = 5'h1c == io_raddr_rs1 ? regs_28 : _GEN_27; // @[ysyx_25030077_gpr.scala 30:{16,16}]
  wire [31:0] _GEN_29 = 5'h1d == io_raddr_rs1 ? regs_29 : _GEN_28; // @[ysyx_25030077_gpr.scala 30:{16,16}]
  wire [31:0] _GEN_30 = 5'h1e == io_raddr_rs1 ? regs_30 : _GEN_29; // @[ysyx_25030077_gpr.scala 30:{16,16}]
  wire [31:0] _GEN_33 = 5'h1 == io_raddr_rs2 ? regs_1 : regs_0; // @[ysyx_25030077_gpr.scala 31:{16,16}]
  wire [31:0] _GEN_34 = 5'h2 == io_raddr_rs2 ? regs_2 : _GEN_33; // @[ysyx_25030077_gpr.scala 31:{16,16}]
  wire [31:0] _GEN_35 = 5'h3 == io_raddr_rs2 ? regs_3 : _GEN_34; // @[ysyx_25030077_gpr.scala 31:{16,16}]
  wire [31:0] _GEN_36 = 5'h4 == io_raddr_rs2 ? regs_4 : _GEN_35; // @[ysyx_25030077_gpr.scala 31:{16,16}]
  wire [31:0] _GEN_37 = 5'h5 == io_raddr_rs2 ? regs_5 : _GEN_36; // @[ysyx_25030077_gpr.scala 31:{16,16}]
  wire [31:0] _GEN_38 = 5'h6 == io_raddr_rs2 ? regs_6 : _GEN_37; // @[ysyx_25030077_gpr.scala 31:{16,16}]
  wire [31:0] _GEN_39 = 5'h7 == io_raddr_rs2 ? regs_7 : _GEN_38; // @[ysyx_25030077_gpr.scala 31:{16,16}]
  wire [31:0] _GEN_40 = 5'h8 == io_raddr_rs2 ? regs_8 : _GEN_39; // @[ysyx_25030077_gpr.scala 31:{16,16}]
  wire [31:0] _GEN_41 = 5'h9 == io_raddr_rs2 ? regs_9 : _GEN_40; // @[ysyx_25030077_gpr.scala 31:{16,16}]
  wire [31:0] _GEN_42 = 5'ha == io_raddr_rs2 ? regs_10 : _GEN_41; // @[ysyx_25030077_gpr.scala 31:{16,16}]
  wire [31:0] _GEN_43 = 5'hb == io_raddr_rs2 ? regs_11 : _GEN_42; // @[ysyx_25030077_gpr.scala 31:{16,16}]
  wire [31:0] _GEN_44 = 5'hc == io_raddr_rs2 ? regs_12 : _GEN_43; // @[ysyx_25030077_gpr.scala 31:{16,16}]
  wire [31:0] _GEN_45 = 5'hd == io_raddr_rs2 ? regs_13 : _GEN_44; // @[ysyx_25030077_gpr.scala 31:{16,16}]
  wire [31:0] _GEN_46 = 5'he == io_raddr_rs2 ? regs_14 : _GEN_45; // @[ysyx_25030077_gpr.scala 31:{16,16}]
  wire [31:0] _GEN_47 = 5'hf == io_raddr_rs2 ? regs_15 : _GEN_46; // @[ysyx_25030077_gpr.scala 31:{16,16}]
  wire [31:0] _GEN_48 = 5'h10 == io_raddr_rs2 ? regs_16 : _GEN_47; // @[ysyx_25030077_gpr.scala 31:{16,16}]
  wire [31:0] _GEN_49 = 5'h11 == io_raddr_rs2 ? regs_17 : _GEN_48; // @[ysyx_25030077_gpr.scala 31:{16,16}]
  wire [31:0] _GEN_50 = 5'h12 == io_raddr_rs2 ? regs_18 : _GEN_49; // @[ysyx_25030077_gpr.scala 31:{16,16}]
  wire [31:0] _GEN_51 = 5'h13 == io_raddr_rs2 ? regs_19 : _GEN_50; // @[ysyx_25030077_gpr.scala 31:{16,16}]
  wire [31:0] _GEN_52 = 5'h14 == io_raddr_rs2 ? regs_20 : _GEN_51; // @[ysyx_25030077_gpr.scala 31:{16,16}]
  wire [31:0] _GEN_53 = 5'h15 == io_raddr_rs2 ? regs_21 : _GEN_52; // @[ysyx_25030077_gpr.scala 31:{16,16}]
  wire [31:0] _GEN_54 = 5'h16 == io_raddr_rs2 ? regs_22 : _GEN_53; // @[ysyx_25030077_gpr.scala 31:{16,16}]
  wire [31:0] _GEN_55 = 5'h17 == io_raddr_rs2 ? regs_23 : _GEN_54; // @[ysyx_25030077_gpr.scala 31:{16,16}]
  wire [31:0] _GEN_56 = 5'h18 == io_raddr_rs2 ? regs_24 : _GEN_55; // @[ysyx_25030077_gpr.scala 31:{16,16}]
  wire [31:0] _GEN_57 = 5'h19 == io_raddr_rs2 ? regs_25 : _GEN_56; // @[ysyx_25030077_gpr.scala 31:{16,16}]
  wire [31:0] _GEN_58 = 5'h1a == io_raddr_rs2 ? regs_26 : _GEN_57; // @[ysyx_25030077_gpr.scala 31:{16,16}]
  wire [31:0] _GEN_59 = 5'h1b == io_raddr_rs2 ? regs_27 : _GEN_58; // @[ysyx_25030077_gpr.scala 31:{16,16}]
  wire [31:0] _GEN_60 = 5'h1c == io_raddr_rs2 ? regs_28 : _GEN_59; // @[ysyx_25030077_gpr.scala 31:{16,16}]
  wire [31:0] _GEN_61 = 5'h1d == io_raddr_rs2 ? regs_29 : _GEN_60; // @[ysyx_25030077_gpr.scala 31:{16,16}]
  wire [31:0] _GEN_62 = 5'h1e == io_raddr_rs2 ? regs_30 : _GEN_61; // @[ysyx_25030077_gpr.scala 31:{16,16}]
  wire [31:0] _GEN_65 = 5'h1 == io_waddr_rd ? regs_1 : regs_0; // @[ysyx_25030077_gpr.scala 34:{27,27}]
  wire [31:0] _GEN_66 = 5'h2 == io_waddr_rd ? regs_2 : _GEN_65; // @[ysyx_25030077_gpr.scala 34:{27,27}]
  wire [31:0] _GEN_67 = 5'h3 == io_waddr_rd ? regs_3 : _GEN_66; // @[ysyx_25030077_gpr.scala 34:{27,27}]
  wire [31:0] _GEN_68 = 5'h4 == io_waddr_rd ? regs_4 : _GEN_67; // @[ysyx_25030077_gpr.scala 34:{27,27}]
  wire [31:0] _GEN_69 = 5'h5 == io_waddr_rd ? regs_5 : _GEN_68; // @[ysyx_25030077_gpr.scala 34:{27,27}]
  wire [31:0] _GEN_70 = 5'h6 == io_waddr_rd ? regs_6 : _GEN_69; // @[ysyx_25030077_gpr.scala 34:{27,27}]
  wire [31:0] _GEN_71 = 5'h7 == io_waddr_rd ? regs_7 : _GEN_70; // @[ysyx_25030077_gpr.scala 34:{27,27}]
  wire [31:0] _GEN_72 = 5'h8 == io_waddr_rd ? regs_8 : _GEN_71; // @[ysyx_25030077_gpr.scala 34:{27,27}]
  wire [31:0] _GEN_73 = 5'h9 == io_waddr_rd ? regs_9 : _GEN_72; // @[ysyx_25030077_gpr.scala 34:{27,27}]
  wire [31:0] _GEN_74 = 5'ha == io_waddr_rd ? regs_10 : _GEN_73; // @[ysyx_25030077_gpr.scala 34:{27,27}]
  wire [31:0] _GEN_75 = 5'hb == io_waddr_rd ? regs_11 : _GEN_74; // @[ysyx_25030077_gpr.scala 34:{27,27}]
  wire [31:0] _GEN_76 = 5'hc == io_waddr_rd ? regs_12 : _GEN_75; // @[ysyx_25030077_gpr.scala 34:{27,27}]
  wire [31:0] _GEN_77 = 5'hd == io_waddr_rd ? regs_13 : _GEN_76; // @[ysyx_25030077_gpr.scala 34:{27,27}]
  wire [31:0] _GEN_78 = 5'he == io_waddr_rd ? regs_14 : _GEN_77; // @[ysyx_25030077_gpr.scala 34:{27,27}]
  wire [31:0] _GEN_79 = 5'hf == io_waddr_rd ? regs_15 : _GEN_78; // @[ysyx_25030077_gpr.scala 34:{27,27}]
  wire [31:0] _GEN_80 = 5'h10 == io_waddr_rd ? regs_16 : _GEN_79; // @[ysyx_25030077_gpr.scala 34:{27,27}]
  wire [31:0] _GEN_81 = 5'h11 == io_waddr_rd ? regs_17 : _GEN_80; // @[ysyx_25030077_gpr.scala 34:{27,27}]
  wire [31:0] _GEN_82 = 5'h12 == io_waddr_rd ? regs_18 : _GEN_81; // @[ysyx_25030077_gpr.scala 34:{27,27}]
  wire [31:0] _GEN_83 = 5'h13 == io_waddr_rd ? regs_19 : _GEN_82; // @[ysyx_25030077_gpr.scala 34:{27,27}]
  wire [31:0] _GEN_84 = 5'h14 == io_waddr_rd ? regs_20 : _GEN_83; // @[ysyx_25030077_gpr.scala 34:{27,27}]
  wire [31:0] _GEN_85 = 5'h15 == io_waddr_rd ? regs_21 : _GEN_84; // @[ysyx_25030077_gpr.scala 34:{27,27}]
  wire [31:0] _GEN_86 = 5'h16 == io_waddr_rd ? regs_22 : _GEN_85; // @[ysyx_25030077_gpr.scala 34:{27,27}]
  wire [31:0] _GEN_87 = 5'h17 == io_waddr_rd ? regs_23 : _GEN_86; // @[ysyx_25030077_gpr.scala 34:{27,27}]
  wire [31:0] _GEN_88 = 5'h18 == io_waddr_rd ? regs_24 : _GEN_87; // @[ysyx_25030077_gpr.scala 34:{27,27}]
  wire [31:0] _GEN_89 = 5'h19 == io_waddr_rd ? regs_25 : _GEN_88; // @[ysyx_25030077_gpr.scala 34:{27,27}]
  wire [31:0] _GEN_90 = 5'h1a == io_waddr_rd ? regs_26 : _GEN_89; // @[ysyx_25030077_gpr.scala 34:{27,27}]
  wire [31:0] _GEN_91 = 5'h1b == io_waddr_rd ? regs_27 : _GEN_90; // @[ysyx_25030077_gpr.scala 34:{27,27}]
  wire [31:0] _GEN_92 = 5'h1c == io_waddr_rd ? regs_28 : _GEN_91; // @[ysyx_25030077_gpr.scala 34:{27,27}]
  wire [31:0] _GEN_93 = 5'h1d == io_waddr_rd ? regs_29 : _GEN_92; // @[ysyx_25030077_gpr.scala 34:{27,27}]
  wire [31:0] _GEN_94 = 5'h1e == io_waddr_rd ? regs_30 : _GEN_93; // @[ysyx_25030077_gpr.scala 34:{27,27}]
  assign io_mem_Req_ready = 1'h1; // @[ysyx_25030077_gpr.scala 37:20]
  assign io_b_ready = 1'h1; // @[ysyx_25030077_gpr.scala 38:14]
  assign io_rdata_rs1 = 5'h1f == io_raddr_rs1 ? regs_31 : _GEN_30; // @[ysyx_25030077_gpr.scala 30:{16,16}]
  assign io_rdata_rs2 = 5'h1f == io_raddr_rs2 ? regs_31 : _GEN_62; // @[ysyx_25030077_gpr.scala 31:{16,16}]
  assign io_ifu_Req_valid = validReg; // @[ysyx_25030077_gpr.scala 36:20]
  assign io_ifu_Req_bits_addr = pc_next_reg; // @[ysyx_25030077_gpr.scala 32:24]
  always @(posedge clock) begin
    if (reset) begin // @[ysyx_25030077_gpr.scala 20:21]
      regs_0 <= 32'h0; // @[ysyx_25030077_gpr.scala 20:21]
    end else if (5'h0 == io_waddr_rd) begin // @[ysyx_25030077_gpr.scala 34:21]
      if (io_mem_Req_valid) begin // @[ysyx_25030077_gpr.scala 34:27]
        if (io_waddr_rd == 5'h0) begin // @[ysyx_25030077_gpr.scala 25:27]
          regs_0 <= 32'h0;
        end else begin
          regs_0 <= io_wdata_rd;
        end
      end else if (5'h1f == io_waddr_rd) begin // @[ysyx_25030077_gpr.scala 34:27]
        regs_0 <= regs_31; // @[ysyx_25030077_gpr.scala 34:27]
      end else begin
        regs_0 <= _GEN_94;
      end
    end
    if (reset) begin // @[ysyx_25030077_gpr.scala 20:21]
      regs_1 <= 32'h0; // @[ysyx_25030077_gpr.scala 20:21]
    end else if (5'h1 == io_waddr_rd) begin // @[ysyx_25030077_gpr.scala 34:21]
      if (io_mem_Req_valid) begin // @[ysyx_25030077_gpr.scala 34:27]
        if (io_waddr_rd == 5'h0) begin // @[ysyx_25030077_gpr.scala 25:27]
          regs_1 <= 32'h0;
        end else begin
        ...
        regs_1 <= regs_31; // @[ysyx_25030077_gpr.scala 34:27]
      end else begin
        regs_1 <= _GEN_94;
      end
    end
    if (reset) begin // @[ysyx_25030077_gpr.scala 20:21]
      regs_2 <= 32'h0; // @[ysyx_25030077_gpr.scala 20:21]
    end else if (5'h2 == io_waddr_rd) begin // @[ysyx_25030077_gpr.scala 34:21]
      if (io_mem_Req_valid) begin // @[ysyx_25030077_gpr.scala 34:27]
        if (io_waddr_rd == 5'h0) begin // @[ysyx_25030077_gpr.scala 25:27]
          regs_2 <= 32'h0;
        end else begin
        ...
        regs_2 <= regs_31; // @[ysyx_25030077_gpr.scala 34:27]
      end else begin
        regs_2 <= _GEN_94;
      end
    end
    if (reset) begin // @[ysyx_25030077_gpr.scala 20:21]
      regs_3 <= 32'h0; // @[ysyx_25030077_gpr.scala 20:21]
    end else if (5'h3 == io_waddr_rd) begin // @[ysyx_25030077_gpr.scala 34:21]
      if (io_mem_Req_valid) begin // @[ysyx_25030077_gpr.scala 34:27]
        if (io_waddr_rd == 5'h0) begin // @[ysyx_25030077_gpr.scala 25:27]
          regs_3 <= 32'h0;
        end else begin
        ...
        regs_3 <= regs_31; // @[ysyx_25030077_gpr.scala 34:27]
      end else begin
        regs_3 <= _GEN_94;
      end
    end
    if (reset) begin // @[ysyx_25030077_gpr.scala 20:21]
      regs_4 <= 32'h0; // @[ysyx_25030077_gpr.scala 20:21]
    end else if (5'h4 == io_waddr_rd) begin // @[ysyx_25030077_gpr.scala 34:21]
      if (io_mem_Req_valid) begin // @[ysyx_25030077_gpr.scala 34:27]
        if (io_waddr_rd == 5'h0) begin // @[ysyx_25030077_gpr.scala 25:27]
          regs_4 <= 32'h0;
        end else begin
        ...
        regs_4 <= regs_31; // @[ysyx_25030077_gpr.scala 34:27]
      end else begin
        regs_4 <= _GEN_94;
      end
    end
    if (reset) begin // @[ysyx_25030077_gpr.scala 20:21]
      regs_5 <= 32'h0; // @[ysyx_25030077_gpr.scala 20:21]
    end else if (5'h5 == io_waddr_rd) begin // @[ysyx_25030077_gpr.scala 34:21]
      if (io_mem_Req_valid) begin // @[ysyx_25030077_gpr.scala 34:27]
        if (io_waddr_rd == 5'h0) begin // @[ysyx_25030077_gpr.scala 25:27]
          regs_5 <= 32'h0;
        end else begin
        ...
        regs_5 <= regs_31; // @[ysyx_25030077_gpr.scala 34:27]
      end else begin
        regs_5 <= _GEN_94;
      end
    end
    if (reset) begin // @[ysyx_25030077_gpr.scala 20:21]
      regs_6 <= 32'h0; // @[ysyx_25030077_gpr.scala 20:21]
    end else if (5'h6 == io_waddr_rd) begin // @[ysyx_25030077_gpr.scala 34:21]
      if (io_mem_Req_valid) begin // @[ysyx_25030077_gpr.scala 34:27]
        if (io_waddr_rd == 5'h0) begin // @[ysyx_25030077_gpr.scala 25:27]
          regs_6 <= 32'h0;
        end else begin
        ...
        regs_6 <= regs_31; // @[ysyx_25030077_gpr.scala 34:27]
      end else begin
        regs_6 <= _GEN_94;
      end
    end
    if (reset) begin // @[ysyx_25030077_gpr.scala 20:21]
      regs_7 <= 32'h0; // @[ysyx_25030077_gpr.scala 20:21]
    end else if (5'h7 == io_waddr_rd) begin // @[ysyx_25030077_gpr.scala 34:21]
      if (io_mem_Req_valid) begin // @[ysyx_25030077_gpr.scala 34:27]
        if (io_waddr_rd == 5'h0) begin // @[ysyx_25030077_gpr.scala 25:27]
          regs_7 <= 32'h0;
        end else begin
        ...
        regs_7 <= regs_31; // @[ysyx_25030077_gpr.scala 34:27]
      end else begin
        regs_7 <= _GEN_94;
      end
    end
    if (reset) begin // @[ysyx_25030077_gpr.scala 20:21]
      regs_8 <= 32'h0; // @[ysyx_25030077_gpr.scala 20:21]
    end else if (5'h8 == io_waddr_rd) begin // @[ysyx_25030077_gpr.scala 34:21]
      if (io_mem_Req_valid) begin // @[ysyx_25030077_gpr.scala 34:27]
        if (io_waddr_rd == 5'h0) begin // @[ysyx_25030077_gpr.scala 25:27]
          regs_8 <= 32'h0;
        end else begin
        ...
        regs_8 <= regs_31; // @[ysyx_25030077_gpr.scala 34:27]
      end else begin
        regs_8 <= _GEN_94;
      end
    end
    if (reset) begin // @[ysyx_25030077_gpr.scala 20:21]
      regs_9 <= 32'h0; // @[ysyx_25030077_gpr.scala 20:21]
    end else if (5'h9 == io_waddr_rd) begin // @[ysyx_25030077_gpr.scala 34:21]
      if (io_mem_Req_valid) begin // @[ysyx_25030077_gpr.scala 34:27]
        if (io_waddr_rd == 5'h0) begin // @[ysyx_25030077_gpr.scala 25:27]
          regs_9 <= 32'h0;
        end else begin
        ...
        regs_9 <= regs_31; // @[ysyx_25030077_gpr.scala 34:27]
      end else begin
        regs_9 <= _GEN_94;
      end
    end
    if (reset) begin // @[ysyx_25030077_gpr.scala 20:21]
      regs_10 <= 32'h0; // @[ysyx_25030077_gpr.scala 20:21]
    end else if (5'ha == io_waddr_rd) begin // @[ysyx_25030077_gpr.scala 34:21]
      if (io_mem_Req_valid) begin // @[ysyx_25030077_gpr.scala 34:27]
        if (io_waddr_rd == 5'h0) begin // @[ysyx_25030077_gpr.scala 25:27]
          regs_10 <= 32'h0;
        end else begin
        ...
        regs_10 <= regs_31; // @[ysyx_25030077_gpr.scala 34:27]
      end else begin
        regs_10 <= _GEN_94;
      end
    end
    if (reset) begin // @[ysyx_25030077_gpr.scala 20:21]
      regs_11 <= 32'h0; // @[ysyx_25030077_gpr.scala 20:21]
    end else if (5'hb == io_waddr_rd) begin // @[ysyx_25030077_gpr.scala 34:21]
      if (io_mem_Req_valid) begin // @[ysyx_25030077_gpr.scala 34:27]
        if (io_waddr_rd == 5'h0) begin // @[ysyx_25030077_gpr.scala 25:27]
          regs_11 <= 32'h0;
        end else begin
        ...
        regs_11 <= regs_31; // @[ysyx_25030077_gpr.scala 34:27]
      end else begin
        regs_11 <= _GEN_94;
      end
    end
    if (reset) begin // @[ysyx_25030077_gpr.scala 20:21]
      regs_12 <= 32'h0; // @[ysyx_25030077_gpr.scala 20:21]
    end else if (5'hc == io_waddr_rd) begin // @[ysyx_25030077_gpr.scala 34:21]
      if (io_mem_Req_valid) begin // @[ysyx_25030077_gpr.scala 34:27]
        if (io_waddr_rd == 5'h0) begin // @[ysyx_25030077_gpr.scala 25:27]
          regs_12 <= 32'h0;
        end else begin
        ...
        regs_12 <= regs_31; // @[ysyx_25030077_gpr.scala 34:27]
      end else begin
        regs_12 <= _GEN_94;
      end
    end
    if (reset) begin // @[ysyx_25030077_gpr.scala 20:21]
      regs_13 <= 32'h0; // @[ysyx_25030077_gpr.scala 20:21]
    end else if (5'hd == io_waddr_rd) begin // @[ysyx_25030077_gpr.scala 34:21]
      if (io_mem_Req_valid) begin // @[ysyx_25030077_gpr.scala 34:27]
        if (io_waddr_rd == 5'h0) begin // @[ysyx_25030077_gpr.scala 25:27]
          regs_13 <= 32'h0;
        end else begin
        ...
        regs_13 <= regs_31; // @[ysyx_25030077_gpr.scala 34:27]
      end else begin
        regs_13 <= _GEN_94;
      end
    end
    if (reset) begin // @[ysyx_25030077_gpr.scala 20:21]
      regs_14 <= 32'h0; // @[ysyx_25030077_gpr.scala 20:21]
    end else if (5'he == io_waddr_rd) begin // @[ysyx_25030077_gpr.scala 34:21]
      if (io_mem_Req_valid) begin // @[ysyx_25030077_gpr.scala 34:27]
        if (io_waddr_rd == 5'h0) begin // @[ysyx_25030077_gpr.scala 25:27]
          regs_14 <= 32'h0;
        end else begin
        ...
        regs_14 <= regs_31; // @[ysyx_25030077_gpr.scala 34:27]
      end else begin
        regs_14 <= _GEN_94;
      end
    end
    if (reset) begin // @[ysyx_25030077_gpr.scala 20:21]
      regs_15 <= 32'h0; // @[ysyx_25030077_gpr.scala 20:21]
    end else if (5'hf == io_waddr_rd) begin // @[ysyx_25030077_gpr.scala 34:21]
      if (io_mem_Req_valid) begin // @[ysyx_25030077_gpr.scala 34:27]
        if (io_waddr_rd == 5'h0) begin // @[ysyx_25030077_gpr.scala 25:27]
          regs_15 <= 32'h0;
        end else begin
        ...
        regs_15 <= regs_31; // @[ysyx_25030077_gpr.scala 34:27]
      end else begin
        regs_15 <= _GEN_94;
      end
    end
    if (reset) begin // @[ysyx_25030077_gpr.scala 20:21]
      regs_16 <= 32'h0; // @[ysyx_25030077_gpr.scala 20:21]
    end else if (5'h10 == io_waddr_rd) begin // @[ysyx_25030077_gpr.scala 34:21]
      if (io_mem_Req_valid) begin // @[ysyx_25030077_gpr.scala 34:27]
        if (io_waddr_rd == 5'h0) begin // @[ysyx_25030077_gpr.scala 25:27]
          regs_16 <= 32'h0;
        end else begin
        ...
        regs_16 <= regs_31; // @[ysyx_25030077_gpr.scala 34:27]
      end else begin
        regs_16 <= _GEN_94;
      end
    end
    if (reset) begin // @[ysyx_25030077_gpr.scala 20:21]
      regs_17 <= 32'h0; // @[ysyx_25030077_gpr.scala 20:21]
    end else if (5'h11 == io_waddr_rd) begin // @[ysyx_25030077_gpr.scala 34:21]
      if (io_mem_Req_valid) begin // @[ysyx_25030077_gpr.scala 34:27]
        if (io_waddr_rd == 5'h0) begin // @[ysyx_25030077_gpr.scala 25:27]
          regs_17 <= 32'h0;
        end else begin
        ...
        regs_17 <= regs_31; // @[ysyx_25030077_gpr.scala 34:27]
      end else begin
        regs_17 <= _GEN_94;
      end
    end
    if (reset) begin // @[ysyx_25030077_gpr.scala 20:21]
      regs_18 <= 32'h0; // @[ysyx_25030077_gpr.scala 20:21]
    end else if (5'h12 == io_waddr_rd) begin // @[ysyx_25030077_gpr.scala 34:21]
      if (io_mem_Req_valid) begin // @[ysyx_25030077_gpr.scala 34:27]
        if (io_waddr_rd == 5'h0) begin // @[ysyx_25030077_gpr.scala 25:27]
          regs_18 <= 32'h0;
        end else begin
        ...
        regs_18 <= regs_31; // @[ysyx_25030077_gpr.scala 34:27]
      end else begin
        regs_18 <= _GEN_94;
      end
    end
    if (reset) begin // @[ysyx_25030077_gpr.scala 20:21]
      regs_19 <= 32'h0; // @[ysyx_25030077_gpr.scala 20:21]
    end else if (5'h13 == io_waddr_rd) begin // @[ysyx_25030077_gpr.scala 34:21]
      if (io_mem_Req_valid) begin // @[ysyx_25030077_gpr.scala 34:27]
        if (io_waddr_rd == 5'h0) begin // @[ysyx_25030077_gpr.scala 25:27]
          regs_19 <= 32'h0;
        end else begin
        ...
        regs_19 <= regs_31; // @[ysyx_25030077_gpr.scala 34:27]
      end else begin
        regs_19 <= _GEN_94;
      end
    end
    if (reset) begin // @[ysyx_25030077_gpr.scala 20:21]
      regs_20 <= 32'h0; // @[ysyx_25030077_gpr.scala 20:21]
    end else if (5'h14 == io_waddr_rd) begin // @[ysyx_25030077_gpr.scala 34:21]
      if (io_mem_Req_valid) begin // @[ysyx_25030077_gpr.scala 34:27]
        if (io_waddr_rd == 5'h0) begin // @[ysyx_25030077_gpr.scala 25:27]
          regs_20 <= 32'h0;
        end else begin
        ...
        regs_20 <= regs_31; // @[ysyx_25030077_gpr.scala 34:27]
      end else begin
        regs_20 <= _GEN_94;
      end
    end
    if (reset) begin // @[ysyx_25030077_gpr.scala 20:21]
      regs_21 <= 32'h0; // @[ysyx_25030077_gpr.scala 20:21]
    end else if (5'h15 == io_waddr_rd) begin // @[ysyx_25030077_gpr.scala 34:21]
      if (io_mem_Req_valid) begin // @[ysyx_25030077_gpr.scala 34:27]
        if (io_waddr_rd == 5'h0) begin // @[ysyx_25030077_gpr.scala 25:27]
          regs_21 <= 32'h0;
        end else begin
        ...
        regs_21 <= regs_31; // @[ysyx_25030077_gpr.scala 34:27]
      end else begin
        regs_21 <= _GEN_94;
      end
    end
    if (reset) begin // @[ysyx_25030077_gpr.scala 20:21]
      regs_22 <= 32'h0; // @[ysyx_25030077_gpr.scala 20:21]
    end else if (5'h16 == io_waddr_rd) begin // @[ysyx_25030077_gpr.scala 34:21]
      if (io_mem_Req_valid) begin // @[ysyx_25030077_gpr.scala 34:27]
        if (io_waddr_rd == 5'h0) begin // @[ysyx_25030077_gpr.scala 25:27]
          regs_22 <= 32'h0;
        end else begin
        ...
        regs_22 <= regs_31; // @[ysyx_25030077_gpr.scala 34:27]
      end else begin
        regs_22 <= _GEN_94;
      end
    end
    if (reset) begin // @[ysyx_25030077_gpr.scala 20:21]
      regs_23 <= 32'h0; // @[ysyx_25030077_gpr.scala 20:21]
    end else if (5'h17 == io_waddr_rd) begin // @[ysyx_25030077_gpr.scala 34:21]
      if (io_mem_Req_valid) begin // @[ysyx_25030077_gpr.scala 34:27]
        if (io_waddr_rd == 5'h0) begin // @[ysyx_25030077_gpr.scala 25:27]
          regs_23 <= 32'h0;
        end else begin
        ...
        regs_23 <= regs_31; // @[ysyx_25030077_gpr.scala 34:27]
      end else begin
        regs_23 <= _GEN_94;
      end
    end
    if (reset) begin // @[ysyx_25030077_gpr.scala 20:21]
      regs_24 <= 32'h0; // @[ysyx_25030077_gpr.scala 20:21]
    end else if (5'h18 == io_waddr_rd) begin // @[ysyx_25030077_gpr.scala 34:21]
      if (io_mem_Req_valid) begin // @[ysyx_25030077_gpr.scala 34:27]
        if (io_waddr_rd == 5'h0) begin // @[ysyx_25030077_gpr.scala 25:27]
          regs_24 <= 32'h0;
        end else begin
        ...
        regs_24 <= regs_31; // @[ysyx_25030077_gpr.scala 34:27]
      end else begin
        regs_24 <= _GEN_94;
      end
    end
    if (reset) begin // @[ysyx_25030077_gpr.scala 20:21]
      regs_25 <= 32'h0; // @[ysyx_25030077_gpr.scala 20:21]
    end else if (5'h19 == io_waddr_rd) begin // @[ysyx_25030077_gpr.scala 34:21]
      if (io_mem_Req_valid) begin // @[ysyx_25030077_gpr.scala 34:27]
        if (io_waddr_rd == 5'h0) begin // @[ysyx_25030077_gpr.scala 25:27]
          regs_25 <= 32'h0;
        end else begin
        ...
        regs_25 <= regs_31; // @[ysyx_25030077_gpr.scala 34:27]
      end else begin
        regs_25 <= _GEN_94;
      end
    end
    if (reset) begin // @[ysyx_25030077_gpr.scala 20:21]
      regs_26 <= 32'h0; // @[ysyx_25030077_gpr.scala 20:21]
    end else if (5'h1a == io_waddr_rd) begin // @[ysyx_25030077_gpr.scala 34:21]
      if (io_mem_Req_valid) begin // @[ysyx_25030077_gpr.scala 34:27]
        if (io_waddr_rd == 5'h0) begin // @[ysyx_25030077_gpr.scala 25:27]
          regs_26 <= 32'h0;
        end else begin
        ...
        regs_26 <= regs_31; // @[ysyx_25030077_gpr.scala 34:27]
      end else begin
        regs_26 <= _GEN_94;
      end
    end
    if (reset) begin // @[ysyx_25030077_gpr.scala 20:21]
      regs_27 <= 32'h0; // @[ysyx_25030077_gpr.scala 20:21]
    end else if (5'h1b == io_waddr_rd) begin // @[ysyx_25030077_gpr.scala 34:21]
      if (io_mem_Req_valid) begin // @[ysyx_25030077_gpr.scala 34:27]
        if (io_waddr_rd == 5'h0) begin // @[ysyx_25030077_gpr.scala 25:27]
          regs_27 <= 32'h0;
        end else begin
        ...
        regs_27 <= regs_31; // @[ysyx_25030077_gpr.scala 34:27]
      end else begin
        regs_27 <= _GEN_94;
      end
    end
    if (reset) begin // @[ysyx_25030077_gpr.scala 20:21]
      regs_28 <= 32'h0; // @[ysyx_25030077_gpr.scala 20:21]
    end else if (5'h1c == io_waddr_rd) begin // @[ysyx_25030077_gpr.scala 34:21]
      if (io_mem_Req_valid) begin // @[ysyx_25030077_gpr.scala 34:27]
        if (io_waddr_rd == 5'h0) begin // @[ysyx_25030077_gpr.scala 25:27]
          regs_28 <= 32'h0;
        end else begin
        ...
        regs_28 <= regs_31; // @[ysyx_25030077_gpr.scala 34:27]
      end else begin
        regs_28 <= _GEN_94;
      end
    end
    if (reset) begin // @[ysyx_25030077_gpr.scala 20:21]
      regs_29 <= 32'h0; // @[ysyx_25030077_gpr.scala 20:21]
    end else if (5'h1d == io_waddr_rd) begin // @[ysyx_25030077_gpr.scala 34:21]
      if (io_mem_Req_valid) begin // @[ysyx_25030077_gpr.scala 34:27]
        if (io_waddr_rd == 5'h0) begin // @[ysyx_25030077_gpr.scala 25:27]
          regs_29 <= 32'h0;
        end else begin
        ...
        regs_29 <= regs_31; // @[ysyx_25030077_gpr.scala 34:27]
      end else begin
        regs_29 <= _GEN_94;
      end
    end
    if (reset) begin // @[ysyx_25030077_gpr.scala 20:21]
      regs_30 <= 32'h0; // @[ysyx_25030077_gpr.scala 20:21]
    end else if (5'h1e == io_waddr_rd) begin // @[ysyx_25030077_gpr.scala 34:21]
      if (io_mem_Req_valid) begin // @[ysyx_25030077_gpr.scala 34:27]
        if (io_waddr_rd == 5'h0) begin // @[ysyx_25030077_gpr.scala 25:27]
          regs_30 <= 32'h0;
        end else begin
        ...
        regs_30 <= regs_31; // @[ysyx_25030077_gpr.scala 34:27]
      end else begin
        regs_30 <= _GEN_94;
      end
    end
    if (reset) begin // @[ysyx_25030077_gpr.scala 20:21]
      regs_31 <= 32'h0; // @[ysyx_25030077_gpr.scala 20:21]
    end else if (5'h1f == io_waddr_rd) begin // @[ysyx_25030077_gpr.scala 34:21]
      if (io_mem_Req_valid) begin // @[ysyx_25030077_gpr.scala 34:27]
        if (io_waddr_rd == 5'h0) begin // @[ysyx_25030077_gpr.scala 25:27]
          regs_31 <= 32'h0;
        end else begin
    ...
    if (reset) begin // @[ysyx_25030077_gpr.scala 21:25]
      validReg <= 1'h0; // @[ysyx_25030077_gpr.scala 21:25]
    end else begin
      validReg <= io_mem_Req_valid | _validReg_T_1; // @[ysyx_25030077_gpr.scala 26:12]
    end
    if (reset) begin // @[ysyx_25030077_gpr.scala 23:28]
      pc_next_reg <= 32'h30000000; // @[ysyx_25030077_gpr.scala 23:28]
    end else if (io_mem_Req_valid) begin // @[ysyx_25030077_gpr.scala 35:21]
...
module ysyx_25030077_pc_next(
  ...
  wire  is_type13 = io_pc_next_type == 4'hd; // @[ysyx_25030077_pc_next.scala 28:34]
  wire  is_eql = io_rs1_data == io_rs2_data; // @[ysyx_25030077_pc_next.scala 30:28]
  wire  is_more_equ = $signed(io_rs1_data) >= $signed(io_rs2_data); // @[ysyx_25030077_pc_next.scala 31:40]
  wire  is_less = $signed(io_rs1_data) < $signed(io_rs2_data); // @[ysyx_25030077_pc_next.scala 32:36]
  wire  is_more_equ_u = io_rs1_data >= io_rs2_data; // @[ysyx_25030077_pc_next.scala 33:35]
  wire  is_less_u = io_rs1_data < io_rs2_data; // @[ysyx_25030077_pc_next.scala 34:31]
  ...
  wire [31:0] _beq_result_T_9 = io_pc_count + _beq_result_T_7; // @[ysyx_25030077_pc_next.scala 38:28]
  ...
  wire  _bne_result_T = ~is_eql; // @[ysyx_25030077_pc_next.scala 58:5]
  ...
  wire [31:0] _io_pc_next_T_9 = io_pc_count + _io_pc_next_T_7; // @[ysyx_25030077_pc_next.scala 62:30]
  ...
  wire [31:0] _io_pc_next_T_16 = io_rs1_data + _io_pc_next_T_14; // @[ysyx_25030077_pc_next.scala 63:31]
  wire [31:0] _io_pc_next_T_18 = _io_pc_next_T_16 & 32'hfffffffe; // @[ysyx_25030077_pc_next.scala 63:94]
  wire [31:0] _io_pc_next_T_19 = is_type13 ? 32'hf001700 : default_pc_next; // @[Mux.scala 101:16]
  wire [31:0] _io_pc_next_T_20 = is_type10 ? bltu_result : _io_pc_next_T_19; // @[Mux.scala 101:16]
  wire [31:0] _io_pc_next_T_21 = is_type9 ? blt_result : _io_pc_next_T_20; // @[Mux.scala 101:16]
  wire [31:0] _io_pc_next_T_22 = is_type8 ? bgeu_result : _io_pc_next_T_21; // @[Mux.scala 101:16]
  wire [31:0] _io_pc_next_T_23 = is_type7 ? bge_result : _io_pc_next_T_22; // @[Mux.scala 101:16]
  wire [31:0] _io_pc_next_T_24 = is_type5 ? bne_result : _io_pc_next_T_23; // @[Mux.scala 101:16]
  wire [31:0] _io_pc_next_T_25 = is_type6 ? beq_result : _io_pc_next_T_24; // @[Mux.scala 101:16]
  wire [31:0] _io_pc_next_T_26 = is_type4 ? io_pc_count : _io_pc_next_T_25; // @[Mux.scala 101:16]
  wire [31:0] _io_pc_next_T_27 = is_type2 ? _io_pc_next_T_18 : _io_pc_next_T_26; // @[Mux.scala 101:16]
  assign io_pc_next = is_type1 ? _io_pc_next_T_9 : _io_pc_next_T_27; // @[Mux.scala 101:16]
...
`endif // RANDOMIZE_REG_INIT
  ...
  wire [2:0] _io_ar_len_T_2 = _io_ar_burst_T_1 ? 3'h4 : 3'h0; // @[ysyx_25030077_icache.scala 100:23]
...
module ysyx_25030077(
  ...
  wire  c_arbiter_io_icache_valid; // @[ysyx_25030077.scala 110:25]
  ...
  wire [31:0] c_arbiter_io_icache_w_data; // @[ysyx_25030077.scala 110:25]
  ...
  wire  c_arbiter_io_icache_ready; // @[ysyx_25030077.scala 110:25]
  ...
  wire  k_icache_clock; // @[ysyx_25030077.scala 117:24]
  wire  k_icache_reset; // @[ysyx_25030077.scala 117:24]
  wire  k_icache_io_ifu_valid; // @[ysyx_25030077.scala 117:24]
  wire [31:0] k_icache_io_pc; // @[ysyx_25030077.scala 117:24]
  wire  k_icache_io_icache_valid; // @[ysyx_25030077.scala 117:24]
  wire [31:0] k_icache_io_icache_data; // @[ysyx_25030077.scala 117:24]
  ...
  wire  k_icache_io_w_valid; // @[ysyx_25030077.scala 117:24]
  wire [31:0] k_icache_io_w_data; // @[ysyx_25030077.scala 117:24]
  wire  k_icache_io_w_ready; // @[ysyx_25030077.scala 117:24]
  wire  k_icache_io_r_valid; // @[ysyx_25030077.scala 117:24]
  wire [31:0] k_icache_io_r_data; // @[ysyx_25030077.scala 117:24]
  wire  k_icache_io_icache_ready; // @[ysyx_25030077.scala 117:24]
  wire  k_icache_io_ifu_ready; // @[ysyx_25030077.scala 117:24]
  ...
  ysyx_25030077_arbiter c_arbiter ( // @[ysyx_25030077.scala 110:25]
    ...
    .io_icache_valid(c_arbiter_io_icache_valid),
    ...
    .io_icache_w_data(c_arbiter_io_icache_w_data),
    ...
    .io_icache_ready(c_arbiter_io_icache_ready),
  ...
  ysyx_25030077_icache k_icache ( // @[ysyx_25030077.scala 117:24]
    .clock(k_icache_clock),
    .reset(k_icache_reset),
    .io_ifu_valid(k_icache_io_ifu_valid),
    .io_pc(k_icache_io_pc),
    .io_icache_valid(k_icache_io_icache_valid),
    .io_icache_data(k_icache_io_icache_data),
    ...
    .io_w_valid(k_icache_io_w_valid),
    .io_w_data(k_icache_io_w_data),
    .io_w_ready(k_icache_io_w_ready),
    .io_r_valid(k_icache_io_r_valid),
    .io_r_data(k_icache_io_r_data),
  ...
  assign c_arbiter_io_icache_valid = k_icache_io_icache_valid; // @[ysyx_25030077.scala 131:29]
  ...
  assign k_icache_io_pc = b_ifu_io_ar_bits_addr; // @[ysyx_25030077.scala 123:18]
  assign k_icache_io_ar_ready = io_master_arready; // @[ysyx_25030077.scala 124:24]
  assign k_icache_io_aw_ready = io_master_awready; // @[ysyx_25030077.scala 125:24]
  assign k_icache_io_w_ready = io_master_wready; // @[ysyx_25030077.scala 126:23]
  assign k_icache_io_r_valid = io_master_rvalid; // @[ysyx_25030077.scala 127:23]
