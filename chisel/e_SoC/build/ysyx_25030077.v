...
module ysyx_25030077_IDU(
  ...
  wire  isaddi = _isaddi_T_2 == 10'h13; // @[ysyx_25030077_IDU.scala 295:64]
  wire  isxori = _isaddi_T_2 == 10'h213; // @[ysyx_25030077_IDU.scala 296:64]
  wire  isori = _isaddi_T_2 == 10'h313; // @[ysyx_25030077_IDU.scala 297:64]
  wire  isandi = _isaddi_T_2 == 10'h393; // @[ysyx_25030077_IDU.scala 298:64]
  wire [15:0] _issrai_T_3 = {io_instruction[31:26],io_instruction[14:12],io_instruction[6:0]}; // @[Cat.scala 31:58]
  wire  issrai = _issrai_T_3 == 16'h4293; // @[ysyx_25030077_IDU.scala 299:87]
  wire  issrli = _issrai_T_3 == 16'h293; // @[ysyx_25030077_IDU.scala 300:87]
  wire  isslli = _issrai_T_3 == 16'h93; // @[ysyx_25030077_IDU.scala 301:87]
  wire  issra = _issrai_T_3 == 16'h42b3; // @[ysyx_25030077_IDU.scala 302:87]
  wire  issrl = _issrai_T_3 == 16'h2b3; // @[ysyx_25030077_IDU.scala 303:87]
  wire  isbeq = _isaddi_T_2 == 10'h63; // @[ysyx_25030077_IDU.scala 304:64]
  wire  isbne = _isaddi_T_2 == 10'he3; // @[ysyx_25030077_IDU.scala 305:64]
  wire [16:0] _isadd_T_3 = {io_instruction[31:25],io_instruction[14:12],io_instruction[6:0]}; // @[Cat.scala 31:58]
  wire  isadd = _isadd_T_3 == 17'h33; // @[ysyx_25030077_IDU.scala 306:87]
  wire  isxor = _isadd_T_3 == 17'h233; // @[ysyx_25030077_IDU.scala 307:87]
  wire  isand = _isadd_T_3 == 17'h3b3; // @[ysyx_25030077_IDU.scala 308:87]
  wire  isor = _isadd_T_3 == 17'h333; // @[ysyx_25030077_IDU.scala 309:87]
  wire  issub = _isadd_T_3 == 17'h8033; // @[ysyx_25030077_IDU.scala 310:87]
  wire  islui = io_instruction[6:0] == 7'h37; // @[ysyx_25030077_IDU.scala 311:36]
  wire  isauipc = io_instruction[6:0] == 7'h17; // @[ysyx_25030077_IDU.scala 312:38]
  wire  isjal = io_instruction[6:0] == 7'h6f; // @[ysyx_25030077_IDU.scala 313:36]
  wire  isjalr = _isaddi_T_2 == 10'h67; // @[ysyx_25030077_IDU.scala 314:65]
  wire  issw = _isaddi_T_2 == 10'h123; // @[ysyx_25030077_IDU.scala 315:63]
  wire  isbge = _isaddi_T_2 == 10'h2e3; // @[ysyx_25030077_IDU.scala 316:63]
  wire  isblt = _isaddi_T_2 == 10'h263; // @[ysyx_25030077_IDU.scala 317:63]
  wire  isbltu = _isaddi_T_2 == 10'h363; // @[ysyx_25030077_IDU.scala 318:63]
  wire  isbgeu = _isaddi_T_2 == 10'h3e3; // @[ysyx_25030077_IDU.scala 319:63]
  wire  issb = _isaddi_T_2 == 10'h23; // @[ysyx_25030077_IDU.scala 320:63]
  wire  issh = _isaddi_T_2 == 10'ha3; // @[ysyx_25030077_IDU.scala 321:63]
  wire  islbu = _isaddi_T_2 == 10'h203; // @[ysyx_25030077_IDU.scala 322:63]
  wire  islb = _isaddi_T_2 == 10'h3; // @[ysyx_25030077_IDU.scala 323:63]
  wire  islw = _isaddi_T_2 == 10'h103; // @[ysyx_25030077_IDU.scala 324:63]
  wire  islh = _isaddi_T_2 == 10'h83; // @[ysyx_25030077_IDU.scala 325:63]
  wire  islhu = _isaddi_T_2 == 10'h283; // @[ysyx_25030077_IDU.scala 326:63]
  wire  issll = _isadd_T_3 == 17'hb3; // @[ysyx_25030077_IDU.scala 327:86]
  wire  isslt = _isadd_T_3 == 17'h133; // @[ysyx_25030077_IDU.scala 328:88]
  wire  issltu = _isadd_T_3 == 17'h1b3; // @[ysyx_25030077_IDU.scala 329:88]
  wire  issltiu = _isaddi_T_2 == 10'h193; // @[ysyx_25030077_IDU.scala 330:65]
  wire  isslti = _isaddi_T_2 == 10'h113; // @[ysyx_25030077_IDU.scala 331:65]
  wire  iscsrrw = _isaddi_T_2 == 10'hf3; // @[ysyx_25030077_IDU.scala 332:67]
  wire  iscsrrs = _isaddi_T_2 == 10'h173; // @[ysyx_25030077_IDU.scala 333:67]
  wire  isebreak = io_instruction == 32'h100073; // @[ysyx_25030077_IDU.scala 334:34]
  wire  iszero = io_instruction == 32'h0; // @[ysyx_25030077_IDU.scala 335:34]
  wire  isecall = io_instruction == 32'h73; // @[ysyx_25030077_IDU.scala 336:34]
  wire  ismret = io_instruction == 32'h30200073; // @[ysyx_25030077_IDU.scala 337:34]
  ...
  wire [3:0] _io_pc_next_type_T_25 = iszero ? 4'h4 : _io_pc_next_type_T_24; // @[Mux.scala 101:16]
  ...
  assign io_ALU_ctrl = _io_ALU_ctrl_T_38[3:0]; // @[ysyx_25030077_IDU.scala 460:15]
...
`endif // RANDOMIZE_REG_INIT
  ...
  wire  _state_reg_T_20 = k == 3'h3; // @[ysyx_25030077_icache.scala 63:99]
  wire [2:0] _state_reg_T_21 = k == 3'h3 ? 3'h4 : 3'h3; // @[ysyx_25030077_icache.scala 63:96]
  wire [2:0] _state_reg_T_22 = io_r_data == 32'h0 ? 3'h6 : _state_reg_T_21; // @[ysyx_25030077_icache.scala 63:68]
  wire [2:0] _state_reg_T_23 = io_r_valid ? _state_reg_T_22 : 3'h3; // @[ysyx_25030077_icache.scala 63:35]
  wire  _state_reg_T_24 = state_reg == 3'h4; // @[ysyx_25030077_icache.scala 64:20]
  wire  _state_reg_T_25 = io_w_ready & io_w_valid; // @[ysyx_25030077_icache.scala 64:48]
  wire [2:0] _state_reg_T_26 = io_w_ready & io_w_valid ? 3'h5 : 3'h4; // @[ysyx_25030077_icache.scala 64:35]
  wire  _state_reg_T_27 = state_reg == 3'h5; // @[ysyx_25030077_icache.scala 65:20]
  wire  _state_reg_T_29 = k == 3'h4; // @[ysyx_25030077_icache.scala 65:72]
  wire [2:0] _state_reg_T_30 = k == 3'h4 ? 3'h0 : 3'h4; // @[ysyx_25030077_icache.scala 65:69]
  wire [2:0] _state_reg_T_31 = _state_reg_T_25 ? _state_reg_T_30 : 3'h5; // @[ysyx_25030077_icache.scala 65:35]
  wire  _state_reg_T_32 = state_reg == 3'h7; // @[ysyx_25030077_icache.scala 66:20]
  wire [2:0] _state_reg_T_34 = io_r_valid ? 3'h6 : 3'h7; // @[ysyx_25030077_icache.scala 66:35]
  wire [2:0] _state_reg_T_35 = _state_reg_T_32 ? _state_reg_T_34 : 3'h0; // @[Mux.scala 101:16]
  wire [2:0] _state_reg_T_36 = _state_reg_T_27 ? _state_reg_T_31 : _state_reg_T_35; // @[Mux.scala 101:16]
  wire [2:0] _state_reg_T_37 = _state_reg_T_24 ? _state_reg_T_26 : _state_reg_T_36; // @[Mux.scala 101:16]
  wire [2:0] _state_reg_T_38 = _state_reg_T_17 ? _state_reg_T_23 : _state_reg_T_37; // @[Mux.scala 101:16]
  wire [2:0] _state_reg_T_39 = _state_reg_T_16 ? 3'h0 : _state_reg_T_38; // @[Mux.scala 101:16]
  wire [2:0] _k_T_5 = k + 3'h1; // @[ysyx_25030077_icache.scala 76:85]
  wire [2:0] _k_T_6 = _state_reg_T_20 ? 3'h0 : _k_T_5; // @[ysyx_25030077_icache.scala 76:66]
  wire [2:0] _k_T_12 = _state_reg_T_25 ? _k_T_5 : k; // @[ysyx_25030077_icache.scala 77:35]
  ...
  wire  _temp_T_1 = _state_reg_T_27 & io_w_ready; // @[ysyx_25030077_icache.scala 86:35]
  ...
  wire  _io_aw_valid_T_2 = _state_reg_T_24 | _state_reg_T_27; // @[ysyx_25030077_icache.scala 109:41]
  ...
  wire  _aw_valid_reg_T_4 = io_r_valid & _state_reg_T_20; // @[ysyx_25030077_icache.scala 116:35]
  ...
  wire [31:0] _io_aw_addr_T_36 = _state_reg_T_27 ? _io_aw_addr_T_35 : 32'h0; // @[Mux.scala 101:16]
  wire [31:0] _io_w_data_T_2 = {4'h0,inst_addr[31:5],1'h1}; // @[Cat.scala 31:58]
  wire [31:0] _io_w_data_T_8 = _state_reg_T_29 ? data3 : 32'h0; // @[Mux.scala 101:16]
  wire [31:0] _io_w_data_T_9 = _state_reg_T_20 ? data2 : _io_w_data_T_8; // @[Mux.scala 101:16]
  ...
  wire [31:0] _io_w_data_T_12 = _state_reg_T_27 ? _io_w_data_T_11 : 32'h0; // @[Mux.scala 101:16]
  assign io_icache_valid = _state_reg_T_16 | _temp_T_1 & io_w_valid & _state_reg_T_29; // @[ysyx_25030077_icache.scala 106:45]
  ...
  assign io_aw_addr = _state_reg_T_24 ? _io_aw_addr_T_17 : _io_aw_addr_T_36; // @[Mux.scala 101:16]
  assign io_w_valid = w_valid_reg; // @[ysyx_25030077_icache.scala 126:16]
  assign io_w_data = _state_reg_T_24 ? _io_w_data_T_2 : _io_w_data_T_12; // @[Mux.scala 101:16]
  ...
  always @(posedge clock) begin
    if (reset) begin // @[ysyx_25030077_icache.scala 35:28]
      ...
      state_reg <= _state_reg_T_39;
    end
    if (reset) begin // @[ysyx_25030077_icache.scala 37:28]
      rdata_reg <= 32'h0; // @[ysyx_25030077_icache.scala 37:28]
    end else if ((_state_reg_T_17 & _data0_T_2 | _state_reg_T_13 | _state_reg_T_32) & io_r_valid) begin // @[ysyx_25030077_icache.scala 105:22]
      rdata_reg <= io_r_data;
    end
    ...
    end else if (_state_reg_T_24) begin // @[Mux.scala 101:16]
      k <= _k_T_12;
    end
    if (reset) begin // @[ysyx_25030077_icache.scala 43:23]
      temp <= 3'h0; // @[ysyx_25030077_icache.scala 43:23]
    end else if (_state_reg_T_27 & io_w_ready & _state_reg_T_29 & is_full) begin // @[ysyx_25030077_icache.scala 86:16]
      temp <= _temp_T_6;
    end
    ...
    end else if (_data0_T_1 & _state_reg_T_20) begin // @[ysyx_25030077_icache.scala 83:17]
      data3 <= io_r_data;
    end
