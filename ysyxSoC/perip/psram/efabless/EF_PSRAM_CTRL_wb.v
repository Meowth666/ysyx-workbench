...
module EF_PSRAM_CTRL_wb (
    ...
    assign sck  = wb_we ? mw_sck  : 
                  we_wq ? mq_sck : mr_sck;
    assign ce_n = wb_we ? mw_ce_n : 
                  we_wq ? mq_ce_n : mr_ce_n;
    assign dout = wb_we ? mw_dout : 
                  we_wq ? mq_dout : mr_dout;
    assign douten  = wb_we ? {4{mw_doe}}  : 
                     we_wq ? {4{mq_doe}} : {4{mr_doe}};
