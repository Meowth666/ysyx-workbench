...
module ysyx_25030077_gpr(
  ...
  function int reg_read_addr();
    return {26'b0, (io_b_valid & io_b_ready), io_waddr_rd};
  endfunction
  ...
  wire  canAccept = 1'b1; // @[ysyx_25030077_gpr.scala 23:27]
  ...
  assign io_mem_Req_ready = canAccept; // @[ysyx_25030077_gpr.scala 23:27]
  assign io_b_ready = canAccept; // @[ysyx_25030077_gpr.scala 23:27]
...
module ysyx_25030077_pc_next(
  ...
  wire [31:0] _io_pc_next_T_28 = is_type1 ? _io_pc_next_T_9 : _io_pc_next_T_27; // @[Mux.scala 101:16]
  assign io_pc_next = is_type11 ? ecall_dnpc : _io_pc_next_T_28; // @[Mux.scala 101:16]
...
`endif // RANDOMIZE_REG_INIT
  ...
  function int icache_read();
    return {24'd0, io_ar_valid, io_ar_ready, state_reg, io_ifu_valid, io_ifu_ready, io_icache_valid};
  endfunction
