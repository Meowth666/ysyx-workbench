...
class alignas(VL_CACHE_LINE_BYTES) VysyxSoCFull_TLToAXI4 final : public VerilatedModule {
  public:
    ...
    struct {
        ...
        VL_OUT8(auto_out_awlock,0,0);
        VL_OUT8(auto_out_awcache,3,0);
        VL_OUT8(auto_out_awprot,2,0);
        VL_OUT8(auto_out_awqos,3,0);
        ...
        VL_OUT8(auto_out_arlock,0,0);
        VL_OUT8(auto_out_arcache,3,0);
        VL_OUT8(auto_out_arprot,2,0);
        VL_OUT8(auto_out_arqos,3,0);
    ...
    struct {
        ...
        CData/*4:0*/ __VdfgRegularize_h1f31f580_0_1;
        CData/*0:0*/ __VdfgRegularize_h1f31f580_0_2;
    ...
    struct {
        ...
        VlWide<3>/*73:0*/ __PVT__queue_arw_deq_q__DOT__ram;
