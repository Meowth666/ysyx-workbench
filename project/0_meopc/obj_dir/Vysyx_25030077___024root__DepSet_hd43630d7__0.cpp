...
void Vysyx_25030077___024root____Vdpiexp_ysyx_25030077__DOT__c_arbiter__DOT__is_lsu_read_TOP(Vysyx_25030077__Syms* __restrict vlSymsp, IData/*31:0*/ &is_lsu_read__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vysyx_25030077___024root____Vdpiexp_ysyx_25030077__DOT__c_arbiter__DOT__is_lsu_read_TOP\n"); );
    // Init
    // Body
    is_lsu_read__Vfuncrtn = (((IData)(vlSymsp->TOP.ysyx_25030077__DOT__c_arbiter__DOT__state_reg) 
                              << 2U) | (((IData)(vlSymsp->TOP.io_master_arvalid) 
                                         << 1U) | (IData)(vlSymsp->TOP.io_master_rvalid)));
}
...
void Vysyx_25030077___024root____Vdpiexp_ysyx_25030077__DOT__f_gpr__DOT__reg_read_addr_TOP(Vysyx_25030077__Syms* __restrict vlSymsp, IData/*31:0*/ &reg_read_addr__Vfuncrtn) {
    ...
    // Init
    // Body
    reg_read_addr__Vfuncrtn = (((IData)(vlSymsp->TOP.ysyx_25030077__DOT__f_gpr__DOT___validReg_T) 
                                << 5U) | (IData)(vlSymsp->TOP.ysyx_25030077__DOT__d_idu_io_rd));
}
...
void Vysyx_25030077___024root___eval_triggers__ico(Vysyx_25030077___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vysyx_25030077___024root___eval_triggers__ico\n"); );
